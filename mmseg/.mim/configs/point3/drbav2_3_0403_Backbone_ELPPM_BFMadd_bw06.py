...
model = dict(
    ...
    auxiliary_head = [
        ...
        dict(
            ...
            align_corners=False,
            loss_decode=[
                dict(type='CrossEntropyLoss', loss_name='loss_ce', use_sigmoid=True, loss_weight=0.6),
                dict(type='DiceLoss', loss_name='loss_dice', loss_weight=0.6)]), 
    ],
...
work_dir = './point3_work_dirs/drbav2_3_0403_Backbone_ELPPM_BFMadd_bw06'